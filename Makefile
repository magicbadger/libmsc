...
pkgdatadir = $(datadir)/libmsc
pkgincludedir = $(includedir)/libmsc
pkglibdir = $(libdir)/libmsc
pkglibexecdir = $(libexecdir)/libmsc
...
PACKAGE_NAME = libmsc
PACKAGE_STRING = libmsc 0.0.1
PACKAGE_TARNAME = libmsc
PACKAGE_URL = 
